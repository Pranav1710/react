...
export class ProductSidebar extends React.Component {
  ...
  componentDidMount(){
    if(this.props.type!=='')
      this.dropdownOpen(this.props.type);
  }
  dropdownOpen = (type)=>{
  ...
  render(){
    const dropdown = (type)=>{
      let t = type=='wall'?'wall':type=='floor'?'floor':type=='parking'?'parking':type=='dc'?'dc':'pg';
      console.log(t);
      this.dropdownOpen(t);
    }
        ...
        <aside className="sidebar">
          ...
          <div className="product-type" id='wall' >
            <h5 className="product-title" onClick={dropdown.bind(this,'wall')}>
              Wall Tiles
              <i className="fa fa-angle-right angle-right" aria-hidden="true"></i>
            </h5>
          ...
          <div className="product-type" id='parking'>
            <h5 className="product-title" onClick={dropdown.bind(this,'parking')}>
              parking Tiles
              <i className="fa fa-angle-right angle-right" aria-hidden="true"></i>
            </h5>
            <ul className="product-items">
          ...
          <div className="product-type" id='floor' >
            <h5 className="product-title" onClick={dropdown.bind(this,'floor')}>
              floor Tiles
              <i className="fa fa-angle-right angle-right" aria-hidden="true"></i>
            </h5>
            <ul className="product-items">
              ...
              <li className="product-sub-type" id='dc'>
                <h6 className="product-sub-title" onClick={dropdown.bind(this,'dc')}>
                  Double Charge
                  <i className="fa fa-angle-right angle-right" aria-hidden="true"></i>
                </h6>
              ...
              <li className="product-sub-type" id='pg'>
                <h6 className="product-sub-title" onClick={dropdown.bind(this,'pg')}>
                  Gvt/Pgvt
                  <i className="fa fa-angle-right angle-right" aria-hidden="true"></i>
                </h6>
                <ul className="product-sub-items">
